  ...
  return (
    <nav className="navbar">
      ...
      <a href="#" className={`nav-link ${activeIcon === "home" ? "active" : ""}`}>
        ...
        <BiHomeAlt size={30} onClick={() =>  handleNavigation("/", "home")} /></a>
      <a href="#" className={`nav-link ${activeIcon === "video" ? "active" : ""}`}>
        <BiVideo size={30} onClick={() => handleNavigation("/video", "video")} /></a>
      <a href="#" className={`nav-link ${activeIcon === "notification" ? "active" : ""}`}><BiBell size={30} onClick={() => handleNavigation("/notification", "notification")}/></a>
      ...
      <div className="navbar-right">
        ...
        <a href="#"className={`nav-icon${activeIcon === "menu" ? "active" : ""}`}>
            <img src="../menu.png" alt="Menu" className="icon" onClick={() =>  handleNavigation("/settings", "menu")}/></a>
